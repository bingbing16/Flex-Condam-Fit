            ...
            <div class="responsive-cell-block wk-desk-3 wk-ipadp-3 wk-tab-6 wk-mobile-12 team-card-container">
                <div class="team-card">
                    <div class="img-wrapper">
                        <img src="{{ $developer->image }}" class="team-img" />
                    </div>
                    <p class="text-blk name">{{ $developer->name }}</p>
                    <p class="text-blk position">{{ $developer->position }}</p>
                    <!-- <p class="text-blk description">{{ $developer->description }}</p> -->
